...
//        createAdjacencyList();
    ...
    public boolean collisionFreePath(PRMapNode p1, PRMapNode p2) {
        Line link = new PRLine(p1.getPoint().x, p1.getPoint().y, p2.getPoint().x, p2.getPoint().y);
        Line up = new PRLine(p1.getPoint().x + ROBOT_WIDTH, p1.getPoint().y + ROBOT_WIDTH, p2.getPoint().x + ROBOT_WIDTH, p2.getPoint().y + ROBOT_WIDTH);
        Line down = new PRLine(p1.getPoint().x - ROBOT_WIDTH, p1.getPoint().y - ROBOT_WIDTH, p2.getPoint().x - ROBOT_WIDTH, p2.getPoint().y - ROBOT_WIDTH);
...
//    }
    ...
    public ArrayList<WayPoint> getRoute(PRMapNode start, PRMapNode goal) {
        connectStartAndGoal(start, goal);
